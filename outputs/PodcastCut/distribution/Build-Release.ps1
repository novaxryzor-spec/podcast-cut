...
try {
    ...
    $runtimeEntries = @('CSXS','ai','index.html','index-v2.html','platform-loader.html','Installer-Mac.command','Uninstall-Mac.command','INSTALL-MAC.txt','style.css','mixed.css','panel.js','core.js','mixed.js','timeline.js','ai-client.js','updater-client.js','host.jsx','package.json','LICENSE','LISEZ-MOI.md','reference-runtime-v1')
